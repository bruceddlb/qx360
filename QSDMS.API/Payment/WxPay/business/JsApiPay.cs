...
namespace QSMS.API.Payment.WxPay
{
    public class JsApiPay
    {
        ...
        public JsApiPay(Controller page)
        {
            this.page = page;
        }
	    ...
	    */
         ...
         * @失败时抛异常WxPayException
         */
        public WxPayData GetUnifiedOrderResult(string tradeNo, string productDesc, string attach, string openid, int amount, string tag)
        {
            //统一下单
            WxPayData data = new WxPayData();
            data.SetValue("body", productDesc);
            data.SetValue("attach", attach);
            data.SetValue("out_trade_no", tradeNo);
            data.SetValue("total_fee", amount);
        ...
        * 
        */
        public string GetJsApiParameters(string appid,string prepay_id)
        {
