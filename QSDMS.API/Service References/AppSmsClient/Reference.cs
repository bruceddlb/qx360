...
namespace QSMS.API.AppSmsClient {
    ...
    public interface IAppSms {
        ...
        QSMS.API.AppSmsClient.SendSmsSameResponse SendSmsSame(QSMS.API.AppSmsClient.SendSmsSameRequest request);
        
        // CODEGEN: 正在生成消息协定，应为该操作具有多个返回值。
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAppSms/SendSmsSame", ReplyAction="http://tempuri.org/IAppSms/SendSmsSameResponse")]
        System.Threading.Tasks.Task<QSMS.API.AppSmsClient.SendSmsSameResponse> SendSmsSameAsync(QSMS.API.AppSmsClient.SendSmsSameRequest request);
        ...
        QSMS.API.AppSmsClient.SendSmsResponse SendSms(QSMS.API.AppSmsClient.SendSmsRequest request);
        
        // CODEGEN: 正在生成消息协定，应为该操作具有多个返回值。
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAppSms/SendSms", ReplyAction="http://tempuri.org/IAppSms/SendSmsResponse")]
        System.Threading.Tasks.Task<QSMS.API.AppSmsClient.SendSmsResponse> SendSmsAsync(QSMS.API.AppSmsClient.SendSmsRequest request);
    ...
    public partial class SendSmsSameRequest {
        ...
        public QSMS.API.AppSmsClient.SmsPropertyEnum sendType;
        ...
        public SendSmsSameRequest(QSMS.API.AppSmsClient.SmsPropertyEnum sendType, string serialNumber, string serialPwd, string[] mobile, string content, long time, int compID, int shopID) {
    ...
    public partial class SendSmsRequest {
        ...
        public SendSmsRequest(QSMS.API.AppSmsClient.SmsPropertyEnum sendType, string serialNumber, string serialPwd, System.Collections.Generic.Dictionary<string, string> mc, long time, int compID, int shopID) {
            this.sendType = sendType;
            this.serialNumber = serialNumber;
            this.serialPwd = serialPwd;
            this.mc = mc;
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAppSmsChannel : QSMS.API.AppSmsClient.IAppSms, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AppSmsClient : System.ServiceModel.ClientBase<QSMS.API.AppSmsClient.IAppSms>, QSMS.API.AppSmsClient.IAppSms {
        ...
        QSMS.API.AppSmsClient.SendSmsSameResponse QSMS.API.AppSmsClient.IAppSms.SendSmsSame(QSMS.API.AppSmsClient.SendSmsSameRequest request) {
            return base.Channel.SendSmsSame(request);
        }
        
        public string SendSmsSame(QSMS.API.AppSmsClient.SmsPropertyEnum sendType, string serialNumber, string serialPwd, string[] mobile, string content, long time, int compID, int shopID, out string error) {
            QSMS.API.AppSmsClient.SendSmsSameRequest inValue = new QSMS.API.AppSmsClient.SendSmsSameRequest();
            ...
            QSMS.API.AppSmsClient.SendSmsSameResponse retVal = ((QSMS.API.AppSmsClient.IAppSms)(this)).SendSmsSame(inValue);
            error = retVal.error;
            return retVal.SendSmsSameResult;
        }
        
        public System.Threading.Tasks.Task<QSMS.API.AppSmsClient.SendSmsSameResponse> SendSmsSameAsync(QSMS.API.AppSmsClient.SendSmsSameRequest request) {
            return base.Channel.SendSmsSameAsync(request);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        QSMS.API.AppSmsClient.SendSmsResponse QSMS.API.AppSmsClient.IAppSms.SendSms(QSMS.API.AppSmsClient.SendSmsRequest request) {
            return base.Channel.SendSms(request);
        }
        
        public string SendSms(QSMS.API.AppSmsClient.SmsPropertyEnum sendType, string serialNumber, string serialPwd, System.Collections.Generic.Dictionary<string, string> mc, long time, int compID, int shopID, out string error) {
            QSMS.API.AppSmsClient.SendSmsRequest inValue = new QSMS.API.AppSmsClient.SendSmsRequest();
            inValue.sendType = sendType;
            inValue.serialNumber = serialNumber;
            inValue.serialPwd = serialPwd;
            inValue.mc = mc;
            ...
            inValue.compID = compID;
            inValue.shopID = shopID;
            QSMS.API.AppSmsClient.SendSmsResponse retVal = ((QSMS.API.AppSmsClient.IAppSms)(this)).SendSms(inValue);
            error = retVal.error;
            return retVal.SendSmsResult;
        }
        
        public System.Threading.Tasks.Task<QSMS.API.AppSmsClient.SendSmsResponse> SendSmsAsync(QSMS.API.AppSmsClient.SendSmsRequest request) {
