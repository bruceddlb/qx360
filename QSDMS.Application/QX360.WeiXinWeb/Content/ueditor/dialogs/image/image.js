...
(function () {
    ...
    SearchImage.prototype = {
        ...
        initEvents: function(){
            ...
            /* 选中图片 */
            domUtils.on($G('seaQX360ist'), 'click', function(e){
                var target = e.target || e.srcElement,
        ...
        getImageData: function(){
            ...
            $G('seaQX360istUl').innerHTML = lang.seaQX360oading;
            ajax.request(url, {
                'dataType': 'jsonp',
                'charset': 'GB18030',
                ...
                'onerror':function(){
                    $G('seaQX360istUl').innerHTML = lang.searchRetry;
                }
            });
        },
        /* 添加图片到列表界面上 */
        ...
        getInsertList: function () {
            var child,
                ...
                align = getAlign(),
                list = [],
                items = $G('seaQX360istUl').children;
