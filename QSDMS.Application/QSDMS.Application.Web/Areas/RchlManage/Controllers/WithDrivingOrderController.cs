...
namespace QSDMS.Application.Web.Areas.QX360Manage.Controllers
{
    ...
    {
        //
        // GET: /QX360Manage/WithDrivingOrder/
        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            if (pageList != null)
            {
                pageList.ForEach((o) =>
                {
                    ...
                    if (o.IsBandCar != null)
                    {
                        o.IsBandCarName = o.IsBandCar == (int)QX360.Model.Enums.IsBandType.带车 ? "个人提供" : "教练提供";
                    }
                });
            }
            var JsonData = new
        ...
        public void ExportExcel(string queryJson)
        {
            ...
            try
            {
                ...
                if (list != null)
                {
                    ...
                    excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "DrivingOrderNo", ExcelColumn = "订单号", Width = 20 });
