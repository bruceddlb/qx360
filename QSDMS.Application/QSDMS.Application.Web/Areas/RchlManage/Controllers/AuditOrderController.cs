            ...
            try
            {
                ...
                if (entity != null)
                {
                    ...
                    if (entity.Status == (int)QX360.Model.Enums.PaySatus.待支付)
                    {
                        ...
                        //送积分
                        GivePointBLL.GivePoint(QX360.Model.Enums.OperationType.预约年检缴费, entity.MemberId, double.Parse(entity.Price.ToString()), entity.AuditOrderNo);
                        //插入财务表
