...
namespace QSDMS.Application.Web.Areas.QX360Manage.Controllers
{
    ...
    {
        //
        // GET: /QX360Manage/TakeAuditOrder/
            ...
            try
            {
                ...
                if (entity != null)
                {
                    ...
                    if (entity.Status == (int)QX360.Model.Enums.PaySatus.待支付)
                    {
                        ...
                        //送积分
                        GivePointBLL.GivePoint(QX360.Model.Enums.OperationType.预约代审缴费, entity.MemberId, double.Parse(entity.Price.ToString()), entity.TakeAuditOrderNo);
                        //插入财务表
                        FinaceBLL.Instance.Add(new FinaceEntity()
                        {
                            FinaceId = QSDMS.Util.Util.NewUpperGuid(),
                            SourceType = (int)QX360.Model.Enums.FinaceSourceType.代审预约,
